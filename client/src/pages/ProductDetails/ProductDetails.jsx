        ...
        <div className="flex flex-col">
          ...
          <div className="mt-8">
            <button
              ...
              className={`w-full rounded-lg px-6 py-4 text-lg font-semibold text-white transition ${isInStock
            ...
            {addedToCart && (
              <div className="mt-4 rounded-lg bg-green-50 p-3 text-center font-medium text-green-700">
